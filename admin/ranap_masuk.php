...
$sql = "
    SELECT 
        ...
        COALESCE(kamar_inap.tgl_keluar, '-') AS tgl_keluar,
        dokter.nm_dokter
    FROM reg_periksa
...
//$sql .= " AND (kamar_inap.tgl_keluar IS NULL OR kamar_inap.tgl_keluar = '')";
...
if (!empty($tgl_masuk)) {
    $sql .= " AND DATE(kamar_inap.tgl_masuk) = ?";
    $params[0] .= "s";
    $params[] = $tgl_masuk;
}
...
$sql .= " ORDER BY kamar_inap.tgl_masuk DESC, kamar_inap.jam_masuk DESC LIMIT ? OFFSET ?";
$params[0] .= "ii";
$params[] = $limit;
$params[] = $offset;
    ...
    <main class="app-main">
        ...
        <div class="app-content-header bg-light p-3">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6">
                        <h3 class="mb-3">Kunjungan Ranap Masuk</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <form method="GET" action="index.php">
                <input type="hidden" name="page" value="ranapmasuk">
